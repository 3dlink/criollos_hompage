	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				{!! Form::open(['route' => 'admin.seo.store', 'method' => 'POST']) !!}

				<div class="panel-body">

					<div class="form-group">
						{!! Form::label('title', 'Title') !!}
						{!! Form::text('title', null, ['placeholder' => 'Page title', 'class' => 'form-control', 'required']) !!}
						<span class="msjError"> @if ($errors->first('title')) *{{ $errors->first('title') }} @endif</span>
					</div>

					<div class="form-group">
						{!! Form::label('description', 'Description') !!}
						{!! Form::text('description', null, ['placeholder' => 'Page description', 'class' => 'form-control', 'required']) !!}
						<span class="msjError"> @if ($errors->first('description')) *{{ $errors->first('description') }} @endif</span>
					</div>

					<div class="form-group clearfix">
						{!! Form::label('keywords', 'Keywords') !!}
						{!! Form::text('keywords', null, ['placeholder' => 'key1, key2, key3...', 'class' => 'form-control', 'required', 'id'=>'keywords']) !!}
				...
				<div class="panel-footer">
					...
					{!! Form::submit('Add SEO', array('class'=>'btn btn-primary')) !!}
				</div>
				{!! Form::close() !!}
