    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                {!! Form::open(['route' => ['admin.clients.update', $client], 'method' => 'PUT', 'files' => 'true']) !!}
	            ...
	            <div class="panel-footer">
	            	<a href="{{ route('admin.clients.index', $category->id) }}"><button class="btn btn-default" type="button">Back</button></a>
